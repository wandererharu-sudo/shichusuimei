...
```bash
cd C:\Users\wande
git clone https://github.com/wandererharu-sudo/shichusuimei-react.git shichusuimei
cd shichusuimei
```
...
別途、GitHub Pagesで公開している。
- 旧HTML版：https://wandererharu-sudo.github.io/shichusuimei/  （`OneDrive\ドキュメント\GitHub\shichusuimei\` で管理）
- React版：未公開（必要になったらvite.config.jsにbase設定追加してGitHub Actionsで自動デプロイ）
